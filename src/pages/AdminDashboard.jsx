                  ...
                  {editingCarId === car._id ? (
                    ...
                    <>
                      <td className="border p-2">
                        <img src={car.image?.url || "/placeholder.jpg"} alt={car.name} className="w-20 h-14 object-cover mx-auto text-black" />
                      </td>
                      ...
                      <td className="border p-2 text-black">₹{car.pricePerDay}</td>
              ...
              {bookings.map((b) => (
                <tr key={b._id}>
                  ...
                  <td className="border p-2 flex gap-2 justify-center text-black">
                    {b.status === "pending" && (
                      <>
                        <button onClick={() => handleUpdateStatus(b._id, "confirmed")} className="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">✅ Confirm</button>
                        <button onClick={() => handleUpdateStatus(b._id, "cancelled")} className="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700">❌ Cancel</button>
                      </>
                    )}
                  </td>
                </tr>
